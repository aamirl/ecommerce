...
module.exports = {
    setup : {
        manufacturer : {
            label : 'Designer',
            placeholder : 'Fossil, Oakley, Tommy HIlfiger, Levi\'s, Timberland',
            verb : 'Designed'
            },
        line : {
            name : {
                label : 'Collection/Usage',
                placeholder : 'Ingram, Ranger,',
                help : 'If the accessory belongs to a collection/brand, then please use this to specify the collection or brand. For example for a "Fossil Men\'s Ingram Extra Capacity Trifold Wallet", this would be simply "Ingram". For "Tumi Monaco Slim Card Case", this would be "Monaco", because that is the collection under which is marketed. For "Hartmann Luggage Capital Leather Card Case", this would be "Luggage Capital". If the accessory has no collection but has a specific usage, use this. For example, for "Jack Spade Embossed Paisley Slim Card Holder Case", this would be simply "Card Case". Another example would be "Robert Graham Men\'s Perry Paisley Embossed Sliding Card Case", for which this would be "Card Case" as well. Please do not use sizes or colors.'
                },
            description : {
